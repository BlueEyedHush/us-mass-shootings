...
def for_year_bin(bin_id):
	...
	by_month['fat_sc'] = by_month['Fatalities'] / by_month['count']
	by_month['inj_sc'] = by_month['Injured'] / by_month['count']
	return by_month
...
def plot(bin_id):
	...
	ax.bar(data.index, data['fat_sc'])
	ax.bar(data.index, data['inj_sc'])
